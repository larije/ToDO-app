...
class _HabitTrackerPageState extends State<HabitTrackerPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 255, 253, 154),
      // appBar: AppBar(
      //   backgroundColor: Colors.grey[900],
